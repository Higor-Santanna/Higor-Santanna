## Higor Santanna Rodrigues 👋
**`Desenvolvedor FrontEnd`**

Desenvolvedor Frontend, com foco em TypeScript, React e NextJS (1 ano e meio). Venho atuando no modelo Freelancer na construção de sistemas para empresas da minha região utilizando o ecossistema TypeScript, boas práticas, planejamento, suporte, teste e implementação. Além disso possuo uma forte experiência com gestão de negócio, logística, atendimento ao cliente e negociação.👨‍💻
...
<div> 
  ...
  <a href="https://www.linkedin.com/in/higor-santanna-rodrigues/" target="_blank"><img src="https://img.shields.io/badge/-LinkedIn-%230077B5?style=for-the-badge&logo=linkedin&logoColor=white" target="_blank"></a> 
